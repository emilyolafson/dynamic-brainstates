...
violin=violinplot([mean(stroke_FO1, 2, 'omitnan')',mean(control_FO1,  2, 'omitnan')',...
    ...
    mean(stroke_FO5,  2, 'omitnan')',mean(control_FO5,  2, 'omitnan')'
...
violin(9).ViolinColor=[0.4 0.4 0.8]
violin(10).ViolinColor=[1 0.4 0.4]
xticks(1:10)
...
[h, p(5), ci, stats]=ttest2(mean(stroke_FO5,  2, 'omitnan'),mean(control_FO5, 2))
...
violin=violinplot([mean(dwell_avg_stroke(:,:,1), 2,'omitnan')',mean(dwell_avg_control(:,:,1), 2)',...
    ...
    mean(dwell_avg_stroke(:,:,5), 2,'omitnan')',mean(dwell_avg_control(:,:,5), 2)'
...
xticklabels({'State 1','    ','State 2','     ','State 3', '','State 4','','State 6'})
set(gca, 'FontSize', 15)
xticks(1:10)
...
[h, p(5), ci, stats]=ttest2(mean(dwell_avg_stroke(:,:,5),2, 'omitnan'),mean(dwell_avg_control(:,:,4),2))
...
violin=violinplot([mean(stroke_appearance1,2, 'omitnan')',mean(control_appearance1,2)',...
    ...
    mean(stroke_appearance4,2, 'omitnan')',mean(control_appearance4,2)',...
    mean(stroke_appearance5,2, 'omitnan')',mean(control_appearance5,2)'], idx)
...
[h, p(5), ci, stats]=ttest2(mean(stroke_appearance5, 2,'omitnan'),mean(control_appearance5,2))
